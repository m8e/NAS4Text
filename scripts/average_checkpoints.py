...
def average_checkpoints(inputs, path_prefix=None):
    """Loads checkpoints from inputs and returns a model with averaged weights.

    Args:
      inputs: An iterable of string paths of checkpoints to load from.
      path_prefix (str): The path prefix of the checkpoints.
...
def main():
    ...
    parser.add_argument('-N', '--net-code-file', dest='net_code_file', type=str, metavar='FILE',
    ...
    path_prefix = get_model_path(args)
    if path_prefix is not None:
        args.output = os.path.join(path_prefix, args.output)
    ...
    new_state = average_checkpoints(args.inputs, path_prefix=path_prefix)
