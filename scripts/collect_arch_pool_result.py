...
if __name__ == '__main__':
    ...
    # main('-i 3 -s 1501 -e 2000 --subset dev -a arch_pool_default_e6d6_dp -n 6 --extra-name full- --exp-dir -'.split(' '))
    ...
    # main('-i mlp3-aug10-old -s 1 -e 30 --subset test -a ap_e6d6_shared_mlp3_aug8_top10 -n 6 --exp-dir -'.split(' '))
    # main('-i mlp4-aug10-old -s 1 -e 30 --subset test -a ap_e6d6_shared_mlp4_aug10_top10 -n 6 --exp-dir -'.split(' '))
    # main('-i mlp3-aug10 -s 1 -e 10 --subset test -a ap_e6d6_shared_mlp3_aug10_top10 -n 6 --exp-dir -'.split(' '))
    main('-i mlp4-aug10 -s 1 -e 10 --subset test -a ap_e6d6_shared_mlp4_aug10_top10 -n 6 --exp-dir -'.split(' '))
